...
software = sclGetCLSoftware("kernels/matrixAddScalar.cl", "matrixAddScalar", hardware);
§SIMPLETYPE§ scl_scalar_add§NUM§ = §B_ID§;
sclManageArgsLaunchKernel(hardware, software, global_size, local_size, "%r %R %a",
    §A_ID§.dataSize, §A_ID§.dataStart, §RES_ID§.dataSize, §RES_ID§.dataStart, sizeof(§SIMPLETYPE§), &scl_scalar_add§NUM§);
